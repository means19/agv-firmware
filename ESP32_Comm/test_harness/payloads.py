...
def build_turn_order_payload(config: HarnessConfig) -> dict:
    """Build an order payload to test cornering/rotation logic."""
    nodes = [
        {"nodeId": "node_start", "sequenceId": 0, "nodePosition": {"x": 0.0, "y": 0.0, "mapId": "map_1"}, "released": True, "actions": []},
        {"nodeId": "node_intersect", "sequenceId": 2, "nodePosition": {"x": 1.0, "y": 0.0, "mapId": "map_1"}, "released": True, "actions": []},
        {"nodeId": "node_end", "sequenceId": 4, "nodePosition": {"x": 1.0, "y": 1.0, "mapId": "map_1"}, "released": True, "actions": []},
    ]

    edges = [
        {"edgeId": "edge_1", "sequenceId": 1, "startNodeId": "node_start", "endNodeId": "node_intersect", "released": True},
        {"edgeId": "edge_2", "sequenceId": 3, "startNodeId": "node_intersect", "endNodeId": "node_end", "released": True},
    ]
